      ...
      <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 animate-slideInUp">
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1 min-w-0">
            <h3 class="text-sm font-semibold text-gray-900">Installer ShopLux</h3>
            <p class="text-xs text-gray-600 mt-1">Ajoutez ShopLux à votre écran d'accueil pour un accès rapide</p>
      ...
      <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 animate-slideInRight">
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-gray-600 mt-1">Une nouvelle version de ShopLux est disponible</p>
            <div class="flex space-x-2 mt-3">
